...
while (<In>) {
	...
	if (/^#/) {
		...
		push @Sample,@info;
		my @out;
		push @out,join("\t","$P1.GT","$P1.AD","$P1.DP","$P1.GQ","$P1.PL") if (defined $P1);
		push @out,join("\t","$P2.GT","$P2.AD","$P2.DP","$P2.GQ","$P2.PL") if (defined $P2);
		push @out,join("\t","$B1.GT","$B1.AD","$B1.DP","$B1.GQ","$B1.PL") if (defined $B1);
		push @out,join("\t","$B2.GT","$B2.AD","$B2.DP","$B2.GQ","$B2.PL") if (defined $B2);
		...
		my @out;
		push @out,join("\t",$samples{$P1}{GT},$samples{$P1}{AD},$samples{$P1}{DP},$samples{$P1}{GQ},$samples{$P1}{PL}) if (defined $P1);
		push @out,join("\t",$samples{$P1}{GT},$samples{$P1}{AD},$samples{$P1}{DP},$samples{$P1}{GQ},$samples{$P1}{PL}) if (defined $P2);
		push @out,join("\t",$samples{$P1}{GT},$samples{$P1}{AD},$samples{$P1}{DP},$samples{$P1}{GQ},$samples{$P1}{PL}) if (defined $B1);
		push @out,join("\t",$samples{$P1}{GT},$samples{$P1}{AD},$samples{$P1}{DP},$samples{$P1}{GQ},$samples{$P1}{PL}) if (defined $B2);
